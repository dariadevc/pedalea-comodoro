...
@section('contenido')
    <div class="w-full 2xl:w-2/3 flex flex-col">
        ...
        <a href="{{ route('bicicletas.create') }}"
            class="shadow-md py-3 px-6 rounded-full transition duration-500 font-semibold uppercase bg-slate-50 outline outline-4 -outline-offset-4 outline-pc-rojo text-pc-rojo hover:bg-pc-rojo hover:text-slate-50 w-80 place-self-end mb-4 text-center">
            Agregar Nueva Bicicleta
        </a>

        <table class="min-w-full border-collapse block md:table shadow-md">
