...
@section('contenido')
    ...
    <div id="divDanios" class="flex flex-col gap-4">
        <div class="">
            <p class="text-pc-texto-p text-sm border-l-4 border-l-pc-azul pl-2">¿La bicicleta recibió daños?
            </p>
        </div>
    ...
    <div class="flex flex-col gap-4">
        <div class="">
            <p class="text-pc-texto-p text-sm border-l-4 border-l-pc-azul pl-2">Ya podes devolver tu bicicleta!</p>
        </div>
        <div class="flex gap-6 self-center">
            <button id="botonId" class="py-2 px-4 rounded-full font-semibold bg-slate-50 shadow-md border-4 border-pc-azul">Devolver
                Bicicleta</button>
        </div>
    </div>
@endsection
    ...
    $(document).ready(function() {
        ...
        $('#divFormDanios').append(`
            ...
            <form id="miFormulario" class="text-pc-texto-p text-sm border-l-4 border-l-pc-azul pl-2">
                ...
                <button id="formDanios" class="py-2 px-4 rounded-full font-semibold bg-slate-50 shadow-md border-4 border-pc-azul" type="button" onclick="mostrarSeleccion()">Seleccionar daños</button>
            </form>
        `);
