<div class="">
    <p id="parrafoInformacion" class="text-pc-texto-p text-sm border-l-4 border-l-pc-rojo pl-2">
        Confirme que los datos de la reserva son correctos
    </p>
</div>

<div id="contenedorDatosReserva"
    class="bg-gradient-to-br from-pc-naranja to-pc-rojo w-full p-4 shadow-md rounded-xl flex flex-col gap-6 mt-4 mb-4">
...
<div class="flex flex-col gap-4">
    <p class="text-pc-texto-p text-sm border-l-4 border-l-pc-rojo pl-2">¿Los datos de la reserva son correctos?</p>
