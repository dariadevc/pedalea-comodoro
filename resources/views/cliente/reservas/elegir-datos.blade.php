...
<div id="contenedorFormDatosReserva"
    ...
    <form id="formularioHorarioRetiro" action="{{ route('estaciones.disponibilidad-horario-retiro') }}" method="POST"
        {{-- class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm"> --}} class="shadow-md rounded-xl flex flex-col gap-6">
        @csrf
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <p id="error-horario_retiro" class="text-black-500 text-sm border-l-4 border-l-pc-rojo pl-2 disabled"></p>
        </div> --}}
