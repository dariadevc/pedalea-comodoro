...
@section('contenido')
    <div class="flex flex-col w-full md:w-3/4 gap-4">
        ...
        <section class="grid
            ...
            {{-- LISTA DE MULTAS --}}
            {{-- TODO: Actualizar tarjetas a medida que realiza nuevas reservas, cada href vincula al movimiento de saldo correspondiente --}}
            {{-- TODO: Agrupar las operaciones por fecha --}}
            <ul class="">
                <li class="flex box-border border-b-2">
                    <a href="#" class="p-4 hover:bg-gray-100 w-full">
                        {{-- INFO DE LA ACTIVIDAD --}}
                        <div class="flex gap-1 items-start justify-between">
                            <h2>Carga de Saldo</h2>
                            <span>$10000.00</span>
                        </div>
                    </a>
                </li>
