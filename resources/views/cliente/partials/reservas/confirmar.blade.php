<div id="contenedorReserva" class="flex flex-col lg:flex-row gap-6 mt-5 w-full">
    <div class="w-full">
        <p id="parrafoInformacion" class="text-pc-texto-h text-base font-bold border-l-4 border-l-pc-rojo pl-2 mb-4">
            Datos de la reserva
        </p>
        <div id="contenedorDatosReserva"
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                <label class="font-semibold text-wrap text-pc-texto-h border-b-2 border-b-pc-texto-h self-start">Estación
                    de
                    retiro</label>
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                <label
                    class="font-semibold text-wrap text-pc-texto-h border-b-2 border-b-pc-texto-h self-start">Estación
                    de
                    devolución</label>
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                <label class="font-semibold text-wrap text-pc-texto-h border-b-2 border-b-pc-texto-h self-start">Horario
                    de
                    retiro</label>
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                <label class="font-semibold text-wrap text-pc-texto-h border-b-2 border-b-pc-texto-h self-start">Tiempo
                    de
                    uso</label>
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                <label class="font-semibold text-wrap text-pc-texto-h border-b-2 border-b-pc-texto-h self-start">Monto
                    total
                    de
                    la reserva</label>
