        ...
        <form id="formularioHorarioRetiro" action="{{ route('estaciones.disponibilidad-horario-retiro') }}" method="POST"
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                ...
                <input type="time" id="horario_retiro" name="horario_retiro"
                    class="bg-gray-50 border-b-2 text-pc-texto-p w-full sm:max-w-xs"
                    onchange="traerEstacionesDisponibles()">
                <div id="error-horario-retiro"
        ...
        <form id="formularioDatosReserva" action="{{ route('reservar.crearReserva') }}" method="POST"
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                <label for="estacion_devolucion"
                    class="font-semibold text-wrap text-pc-texto-h border-b-2 border-b-pc-texto-h self-start">Estación
                    de Devolución</label>
                <select id="estacion_devolucion" name="estacion_devolucion"
                    class="bg-gray-50 border-b-2 text-pc-texto-p" disabled></select>
            ...
            <div class="flex flex-col gap-2 py-2 px-4 bg-gray-50 rounded-xl shadow-sm">
                <label for="tiempo_uso"
                    ...
                    uso</label>
                <select id="tiempo_uso" name="tiempo_uso" class="bg-gray-50 border-b-2 text-pc-texto-p"
                    disabled></select>
