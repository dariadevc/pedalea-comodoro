...
<div id="contenedorConsultaDanios" class="flex flex-col gap-4">
    ...
    <div class="flex gap-6 self-center">
        <form id="formularioMostrarDanios" action="{{ route('devolver.mostrar-danios', $id_reserva) }}" method="POST">
            @csrf
        ...
        <form id="formularioSinDanios" action="{{ route('devolver.sin-danios', $id_reserva) }}" method="POST">
            @csrf
