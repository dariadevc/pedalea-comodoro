...
<form id="formularioDanios" action="{{ route('devolver.guardar-danios', $id_reserva) }}" method="POST" class="flex flex-col gap-3 p-4 shadow-md rounded-xl border border-pc-azul bg-white">
    @csrf
