...
<div class="grid grid-cols-2 gap-6">
    {{-- CONSULTAR SALDO --}}
    <a class=" bg-gray-50 w-full h-36 p-4 shadow-md rounded-xl flex flex-col items-center gap-1" href="{{ route('inspector.bicicletas') }}">
        <img src="img/bicicleta.png" alt="" class="h-14 w-14">
        <h3 class="text-center text-pc-texto-h semibol">Deshabilitar las bicicletas</h3>
    </a>
    {{-- VER MAPA --}}
    <a class=" bg-gray-50 w-full h-36 p-4 shadow-md rounded-xl flex flex-col items-center gap-1" href="{{ route('inspector.infraccion') }}">
