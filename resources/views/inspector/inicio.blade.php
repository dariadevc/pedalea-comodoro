...
<div class="flex flex-col items-center gap-1">
    ...
    <p class="text-xl font-semibold text-pc-texto-h">¡Hola Inspector <span class="font-bold text-pc-rojo"> {{ Auth::user()->nombre }}</span>!</p>
</div>
<div class="grid grid-cols-2 gap-6">
    {{-- CONSULTAR SALDO --}}
    <div class=" bg-gray-50 w-full h-36 p-4 shadow-md rounded-xl flex flex-col items-center gap-1" onclick="window.location.href='{{ route('inspector.bicicletas') }}'">
        <img src="img/bicicleta.png" alt="" class="h-14 w-14">
        <h3 class="text-center text-pc-texto-h semibol">Deshabilitar las bicicletas</h3>
    </div>
    {{-- VER MAPA --}}
    <div class=" bg-gray-50 w-full h-36 p-4 shadow-md rounded-xl flex flex-col items-center gap-1" onclick="window.location.href='{{ route('inspector.infraccion') }}'">
        <svg width="50px" height="50px" viewBox="-0.5 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg" class="mt-1">
